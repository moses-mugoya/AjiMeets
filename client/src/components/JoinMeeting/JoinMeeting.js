                    ...
                    <Grid item xs={12} sm={5} md={5} component={Paper} elevation={4} square>
                        <div className={classes.paper}>
                            ...
                            <form className={classes.form} noValidate onSubmit={this.handleSubmit}>
                                ...
                                />
                                <Link to={`/meeting-room?name=${this.state.firstName + ' ' + this.state.lastName}&room=${this.state.meetingID}`} style={{ textDecoration: "none" }} >
                                    <Button
                                        type="submit"
                                        fullWidth
                                        variant="contained"
...
export default compose(connect(mapStateToProps), withStyles(useStyles))(JoinMeeting) 
